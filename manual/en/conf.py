...
project = u'MiT For CoraDB'
copyright = u'2026, CUBRID Corporation'
...
# -- Options for PDF output (sphinx-simplepdf) ---------------------------------
...
simplepdf_vars = {
    ...
    'cover': 'white',
    'white': 'white',
    'cover-bg': 'linear-gradient(180deg, #404040 0%, #202020 100%)',
}

simplepdf_file_name = 'MiT_Manual_en.pdf'
...
latex_documents = [
  ('index', 'MiT_Manual_en.tex', u'MiT 3.0 User Manual',
